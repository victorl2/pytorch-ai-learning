...
if __name__ == '__main__':
    ...
    EPOCHS = 4 # EPOCH is a complete pass in all values in the training dataset

    print("\nTraining the neural network in 4 EPOCHS")
    ...
    print("\nThe model Accuracy is:", round(correct/total, 3) * 100, "%")

    print("Prediction for a value in the dataset")
